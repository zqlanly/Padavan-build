  ...
  build:
    ...
    - name: Build Firmware
      ...
      run: |
        ...
        sed -i 's/CONFIG_FIRMWARE_VLMCSD=y/CONFIG_FIRMWARE_INCLUDE_VLMCSD=n/g' .config
        ...
        ##内网穿透服务##
        #echo "CONFIG_FIRMWARE_INCLUDE_ADGUARDHOME=y" >> .config  #ALDRIVER  ~3m
        echo "CONFIG_FIRMWARE_INCLUDE_FRPC=y" >> .config #mentohust
